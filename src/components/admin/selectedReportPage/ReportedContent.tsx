  ...
  return (
    <>
      {report.contentType === 'message' && report.message ? (
        <section className="reported-message h-[200px] lg:h-full border border-[#E5C6AC] rounded-lg p-5">
          <p className="text-sm">
        ...
        <section className='reported-photo h-[600px] lg:h-full border border-[#E5C6AC] rounded-lg p-5'>
          <PhotoModal
            photo={report.photo}
            height='h-full'
            allowDelete={false}
        ...
        <section className='h-[200px] lg:h-full border border-[#E5C6AC] rounded-lg p-5'>
